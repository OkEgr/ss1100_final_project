...
2.  **What was the most challenging section, and why?** Feel free to provide more than one response if there is a difference of opinion in the group.
   Payload ended up being the most challenging section. Accounting for dynamic matrix sizing, potential presence of headers, and data type proved to be pretty challenging. It took a fair amount of trial and error with some help from ChatGpt to get all sections and the check-plus requirement working.
